                ...
                <div className="input-form-container">
                    ...
                    <div className="input-group desc">
                        ...
                        <div className="input-desc-wrapper">
                            ...
                            <textarea className="input-desc" id="input-desc1" type="text" onChange={(event) => setTour_desc(event.target.value)} style={{ backgroundColor: '#fff', width: '100%' }} />
                        </div>
                    </div>
                    <div className="input-group" style={{ display: 'block', marginTop: 24 }}>
                        ...
                        <div className="input-group-container" style={{ backgroundColor: '#F5F4F2', padding: 24, margin: '12px 0 36px', borderRadius: 12, boxShadow: '12px 12px 24px 0 rgba(107, 107, 107, 0.25)' }}>
                            ...
                            <div className="input-group desc">
                                ...
                                <div className="input-desc-wrapper">
                                    ...
                                    <textarea style={{ width: '100%' }} onChange={(event) => setRoute_desc(event.target.value)} className="input-desc" id="input-desc2" type="text" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="input-group-container" style={{ backgroundColor: '#F5F4F2', padding: 24, margin: '12px 0 36px', borderRadius: 12, boxShadow: '12px 12px 24px 0 rgba(107, 107, 107, 0.25)' }}>
                            ...
                            <div className="input-group desc">
                                ...
                                <div className="input-desc-wrapper">
                                    <label htmlFor="input-desc2">Mô tả chi tiết</label>
                                    <textarea style={{ width: '100%' }} onChange={(event) => setRoute_desc2(event.target.value)} className="input-desc" id="input-desc2" type="text" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="input-group-container" style={{ backgroundColor: '#F5F4F2', padding: 24, margin: '12px 0 36px', borderRadius: 12, boxShadow: '12px 12px 24px 0 rgba(107, 107, 107, 0.25)' }}>
                            ...
                            <div className="input-group desc">
                                ...
                                <div className="input-desc-wrapper">
                                    <label htmlFor="input-desc2">Mô tả chi tiết</label>
                                    <textarea style={{ width: '100%' }} onChange={(event) => setRoute_desc3(event.target.value)} className="input-desc" id="input-desc2" type="text" />
                                </div>
                            </div>
                        </div>
